...
interface WorkingZoomMeetingProps {
...
const WorkingZoomMeeting = ({
  ...
  const toggleMute = () => {
    // Toggle mute state locally for now
    setIsMuted(!isMuted);
    updateParticipants();
  };

  const toggleVideo = () => {
    // Toggle video state locally for now
    setIsVideoOn(!isVideoOn);
    updateParticipants();
  };

  const toggleScreenShare = () => {
    // Toggle screen share state locally for now
    setIsScreenSharing(!isScreenSharing);
  };

  const toggleRecording = () => {
    // Toggle recording state locally for now
    ...
    <div className="h-screen bg-dark-900 flex flex-col">
      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 bg-black relative">
          ...
          <div id="zoomMeetingContainer" className="w-full h-full" />
...
export default WorkingZoomMeeting;
